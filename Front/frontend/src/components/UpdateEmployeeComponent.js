...
export default function UpdateEmployeeComponent(props) {
    ...
    const updateHandler = (e) => {
        e.preventDefault();
        const employee = { empId, firstName, lastName, email };
                ...
                <div className="card col-md-6 offset-md-3 offset-md-3">
                    ...
                    <form onSubmit={updateHandler}>
                        ...
                        <div className="form-group my-2">
                            ...
                            <input placeholder="Last Name" name="lastName" className="form-control" value={lastName} onChange={(e) => setLastName(e.target.value)} pattern="[A-Za-z0-9@#$%^&* ]{3,12}" required />
